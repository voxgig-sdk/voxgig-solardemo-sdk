...
function hmac(key, text) {
    return (0, node_crypto_1.createHmac)('sha256', key).update(text, 'utf8').digest();
}
...
function sigv4(input) {
    ...
    const signature = (0, node_crypto_1.createHmac)('sha256', ksigning).update(stringtosign, 'utf8').digest('hex');
    const out = {
