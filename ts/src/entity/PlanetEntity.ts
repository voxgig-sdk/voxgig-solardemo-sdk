...
class PlanetEntity extends SolardemoEntityBase<Planet> {
  ...
  async create(this: any, reqdata?: PlanetCreateData, ctrl?: Control): Promise<PlanetEntity> {
  ...
  async update(this: any, reqdata?: PlanetUpdateData, ctrl?: Control): Promise<PlanetEntity> {
  ...
  async remove(
    this: any, reqmatch?: PlanetRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<PlanetEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
