...
class PlanetEntity
{
     ...
     * Create a new Planet.
     *
     * @param PlanetCreateData|array|null $reqdata Body data as an assoc-array;
     ...
     *
     * @param PlanetUpdateData|array|null $reqdata Body data as an assoc-array;
     ...
     *
     * @param PlanetRemoveMatch|array|null $reqmatch Match criteria (id/query
