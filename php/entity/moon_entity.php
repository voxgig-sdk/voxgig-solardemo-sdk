...
class MoonEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MoonEntity($this->_client, $opts);
    }

    /**
     * @param Moon|array $args Moon data (assoc-array) to store.
     */
    ...
    /**
     * @return Moon|array The current Moon data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Moon fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Moon fields).
     */
     ...
     * Load a single Moon.
     *
     * @param MoonLoadMatch|array|null $reqmatch Match criteria (id/query
     ...
     *
     * @param MoonListMatch|array|null $reqmatch Match filter (any subset
     ...
     * Create a new Moon.
     *
     * @param MoonCreateData|array|null $reqdata Body data as an assoc-array;
     ...
     *
     * @param MoonUpdateData|array|null $reqdata Body data as an assoc-array;
     ...
     *
     * @param MoonRemoveMatch|array|null $reqmatch Match criteria (id/query
