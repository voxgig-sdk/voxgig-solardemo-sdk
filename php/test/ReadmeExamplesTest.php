...
//      EXECUTED offline in seeded test mode (SolardemoSDK::test)
...
{
    private const SDK_CLASS = 'SolardemoSDK';
    ...
    private const SDK_BASE = 'solardemo_sdk';
