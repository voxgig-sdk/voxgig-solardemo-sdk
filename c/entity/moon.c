// Moon entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*moon_postdone_fn)(moon_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT moon_VT;
static const char* moon_get_name(Entity* e);
static Entity* moon_make(Entity* e);
static voxgig_value* moon_data(Entity* e, voxgig_value* args);
static voxgig_value* moon_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* moon_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** moon_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* moon_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* moon_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* moon_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void moon_mark_deleted(Entity* e);
static bool moon_deleted(Entity* e);

static Context* moon_ent_ctx(moon_entity* self) {
  return self->entctx;
}
...
Entity* moon_entity_new(SolardemoSDK* client, voxgig_value* entopts) {
  ...
  moon_entity* self = (moon_entity*)calloc(1, sizeof(moon_entity));
  self->base.vt = &moon_VT;
  self->name = strdup("moon");
  self->client = client;
...
static voxgig_value* moon_run_op(moon_entity* self, Context* ctx,
                                    moon_postdone_fn post_done, PNError** err) {
...
voxgig_value* moon_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  moon_entity* self = (moon_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, moon_ent_ctx(self));
...
static Entity* moon_make(Entity* e) {
  ...
  return moon_entity_new(self->client, opts);
}
...
static voxgig_value* moon_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(moon_ent_ctx(self), "SetData");
  }
  feature_hook_util(moon_ent_ctx(self), "GetData");
...
static voxgig_value* moon_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(moon_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(moon_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void moon_load_postdone(moon_entity* self, Context* ctx) {
...
static Entity* moon_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, moon_ent_ctx(self));
  moon_run_op(self, ctx, moon_load_postdone, err);
  if (*err) return NULL;
...
static void moon_list_postdone(moon_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    if (voxgig_is_map(resmatch)) self->mtch = resmatch;
...
static Entity** moon_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, moon_ent_ctx(self));
  voxgig_value* out = moon_run_op(self, ctx, moon_list_postdone, err);
  if (*err) return NULL;
...
static void moon_create_postdone(moon_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static Entity* moon_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, moon_ent_ctx(self));
  moon_run_op(self, ctx, moon_create_postdone, err);
  if (*err) return NULL;
...
static void moon_update_postdone(moon_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static Entity* moon_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, moon_ent_ctx(self));
  moon_run_op(self, ctx, moon_update_postdone, err);
  if (*err) return NULL;
...
static void moon_remove_postdone(moon_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static Entity* moon_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, moon_ent_ctx(self));
  moon_run_op(self, ctx, moon_remove_postdone, err);
  if (*err) return NULL;
...
// live record.
static void moon_mark_deleted(Entity* e) {
  ((moon_entity*)e)->deleted = true;
}

static bool moon_deleted(Entity* e) {
  return ((moon_entity*)e)->deleted;
}
