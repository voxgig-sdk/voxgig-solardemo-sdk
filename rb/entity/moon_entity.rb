...
class MoonEntity
  ...
  # @return [Moon, Hash] the current Moon data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Moon fields)
  def match_get
  ...
  # Load a single Moon.
  #
  # @param reqmatch [MoonLoadMatch, Hash, nil] match criteria (id/query fields);
