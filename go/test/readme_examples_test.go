...
const testSeed = `map[string]any{"entity": map[string]any{"moon": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "planet": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
