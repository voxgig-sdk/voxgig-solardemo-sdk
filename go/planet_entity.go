...
// PlanetEntity represents the Planet entity.
...
// NewPlanetEntity creates a new Planet entity.
...
func (e *PlanetEntity) EntOpts() map[string]any {
	out, _ := sdk.Clone(e.entopts).(map[string]any)
	return out
}

// Client returns the SDK client.
func (e *PlanetEntity) Client() *SolardemoSDK {
	return e.client
}

// Make creates a new entity instance.
func (e *PlanetEntity) Make() *PlanetEntity {
	return NewPlanetEntity(e.client, e.EntOpts())
}

// Data gets or sets entity data.
func (e *PlanetEntity) Data(data ...map[string]any) map[string]any {
...
func (e *PlanetEntity) Match(match ...map[string]any) map[string]any {
...
func (e *PlanetEntity) Name() string {
	return e.name
}
