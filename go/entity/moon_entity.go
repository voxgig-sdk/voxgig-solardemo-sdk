...
func (e *MoonEntity) GetName() string { return e.name }
...
func (e *MoonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MoonEntity) Deleted() bool {
	return e.deleted
}


func (e *MoonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMoonEntity(e.client, opts)
}

func (e *MoonEntity) Data(args ...any) any {
...
func (e *MoonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *MoonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
