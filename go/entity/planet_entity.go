...
func NewPlanetEntity(client *core.VoxgigSolardemoSDK, entopts map[string]any) *PlanetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
// PlanetCreateData and returns an Planet. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PlanetEntity) CreateTyped(reqdata PlanetCreateData, ctrl map[string]any) (Planet, error) {
...
// PlanetUpdateData and returns an Planet. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *PlanetEntity) UpdateTyped(reqdata PlanetUpdateData, ctrl map[string]any) (Planet, error) {
...
// PlanetRemoveMatch and returns an Planet. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PlanetEntity) RemoveTyped(reqmatch PlanetRemoveMatch, ctrl map[string]any) (Planet, error) {
