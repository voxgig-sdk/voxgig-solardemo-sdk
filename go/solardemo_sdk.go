...
func (sdk *SolardemoSDK) Moon(data map[string]any) *MoonEntity {
	return NewMoonEntity(sdk, data)
}

func (sdk *SolardemoSDK) Planet(data map[string]any) *PlanetEntity {
	return NewPlanetEntity(sdk, data)
}
