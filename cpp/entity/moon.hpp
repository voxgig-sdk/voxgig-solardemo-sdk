// Moon entity client (generated). Shared entity runtime (data/match
...
class MoonEntity : public EntityBase {
public:
  MoonEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("moon", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<MoonEntity>(this->client, opts);
  }
