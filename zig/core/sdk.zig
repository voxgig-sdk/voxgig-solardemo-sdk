...
pub const SolardemoSDK = struct {
    ...
    pub fn moon(self: *@This(), entopts: Value) *@import("../entity/moon.zig").MoonEntity {
        return @import("../entity/moon.zig").MoonEntity.new(self, entopts);
    }

    /// Planet entity bound to this client.
    pub fn planet(self: *@This(), entopts: Value) *@import("../entity/planet.zig").PlanetEntity {
        return @import("../entity/planet.zig").PlanetEntity.new(self, entopts);
    }
