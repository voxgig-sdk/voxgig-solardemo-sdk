...
# and tm/swift/Tests/SolardemoSDKTests/OmniResolver.swift.
#
...
defmodule Solardemo.Omni do
  ...
  defp sdkprovider(client) do
    utility = Solardemo.get_utility(client)
    ...
    %{
      ...
      client: fn options -> sdkprovider(Solardemo.test(nil, tostruct(options))) end,
  ...
  def errify(%Solardemo.Error{} = err) do
