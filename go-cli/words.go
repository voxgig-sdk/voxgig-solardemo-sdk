...
func registerSDKWords(r *eng.Registry, client *sdk.SolardemoSDK) {
...
func runOp(client *sdk.SolardemoSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
