...
import voxgig.solardemosdk.sdktest.RunnerSupport.getSpec
import voxgig.solardemosdk.sdktest.RunnerSupport.loadTestSpec
import voxgig.solardemosdk.sdktest.RunnerSupport.makeCtxFromMap
import voxgig.solardemosdk.sdktest.RunnerSupport.runset
...
class PrimaryUtilityTest {
  ...
  private fun client(): SolardemoSDK = SolardemoSDK.testSDK()

  private fun makeTestCtx(client: SolardemoSDK, utility: Utility, overrides: MutableMap<String, Any?>?): Context {
  ...
  private fun makeTestFullCtx(client: SolardemoSDK, utility: Utility): Context {
  ...
  fun fetcherBlockedTestMode() {
    val blockedClient = SolardemoSDK(
      fhMap(
        "system",
  ...
  fun makeSpecBasic() {
    ...
    val specClient = SolardemoSDK.testSDK(null, setupOpts)
  ...
  fun prepareAuthBasic() {
    ...
    val authClient = SolardemoSDK.testSDK(null, setupOpts)
