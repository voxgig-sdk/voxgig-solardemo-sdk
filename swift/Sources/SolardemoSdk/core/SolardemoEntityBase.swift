// SolardemoEntityBase - shared entity behaviour: construction, data/match
...
open class SolardemoEntityBase: Entity {
  var name: String
  var client: SolardemoSDK
  var utility: Utility
  var entopts: VMap
  var data = VMap()
  var match = VMap()
  ...
  public init(_ client: SolardemoSDK, _ entoptsIn: VMap?, _ name: String) {
  ...
  open func make() -> Entity {
    return SolardemoEntityBase(client, cloneOpts(), name)
  }
