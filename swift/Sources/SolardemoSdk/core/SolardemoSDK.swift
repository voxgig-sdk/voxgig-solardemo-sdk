...
public final class SolardemoSDK {
  ...
  private func opDenied(_ op: String) -> VMap {
    ...
    r.entries["err"] = .nat(SolardemoError(
      op + "_allow",
      "SolardemoSDK: \(op): operation not allowed by SDK option "
  ...
  public func graphql(
    ...
    res.entries["err"] = .nat(SolardemoError(
      "graphql_error", "SolardemoSDK: graphql: " + msg, nil))
  ...
  public func Moon(_ entopts: VMap? = nil) -> SolardemoEntityBase {
  ...
  public func Planet(_ entopts: VMap? = nil) -> SolardemoEntityBase {
    return PlanetEntity(self, entopts)
  }


  public static func testSDK(_ testoptsIn: VMap?, _ sdkoptsIn: VMap?) -> SolardemoSDK {
