// SolardemoError: the SDK error type (mirrors go core/error.go / the rust
...
pub const SolardemoError = struct {
    sdk: []const u8 = "Solardemo",
    code: []const u8,
    msg: []const u8,
    ...
    pub fn make(code: []const u8, msg: []const u8) *SolardemoError {
        const e = mem.a().create(SolardemoError) catch unreachable;
        e.* = .{ .sdk = "Solardemo", .code = code, .msg = msg };
        return e;
    }
};
