# Solardemo SDK core runtime objects.
#
...
defmodule Solardemo.Control do
...
defmodule Solardemo.Response do
  alias Voxgig.Struct, as: S
...
defmodule Solardemo.Operation do
  alias Voxgig.Struct, as: S
