...
public final class Context {
  ...
  public var client: SolardemoSDK?
  ...
  public init(_ ctxmap: [String: Any?]?, _ basectx: Context?) {
    ...
    // Client
    if let sdk = ctxProp(ctxmap, "client") as? SolardemoSDK { client = sdk }
  ...
  public func makeError(_ code: String, _ msg: String) -> SolardemoError {
