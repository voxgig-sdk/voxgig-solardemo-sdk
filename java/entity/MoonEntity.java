...
public class MoonEntity extends EntityBase {

  public MoonEntity(SdkClient client, Map<String, Object> entopts) {
    super("moon", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new MoonEntity(this.client, opts);
  }
