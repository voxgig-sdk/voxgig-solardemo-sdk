...
public class PrimaryUtilityTest
{
    ...
    private readonly SolardemoSDK _client;
    ...
    public PrimaryUtilityTest()
    {
        ...
        _client = SolardemoSDK.TestSDK(null, null);
        _utility = _client.GetUtility();
    }

    // Helper: create basic test context.
    private Context MakeTestCtx(SolardemoSDK client, Utility utility,
    ...
    private Context MakeTestFullCtx(SolardemoSDK client, Utility utility)
    {
    ...
    {
        var hookClient = SolardemoSDK.TestSDK(null, null);
    ...
    {
        var initClient = SolardemoSDK.TestSDK(null, null);
    ...
    public void FetcherBlockedTestMode()
    {
        ...
        var blockedClient = new SolardemoSDK(new Dictionary<string, object?>
        {
            ["system"] = new Dictionary<string, object?>
            {
                ["fetch"] = (Func<string, Dictionary<string, object?>, Dictionary<string, object?>>)
    ...
    public void MakeSpecBasic()
    {
        ...
        var specClient = SolardemoSDK.TestSDK(null, setupOpts);
    ...
    public void PrepareAuthBasic()
    {
        ...
        var authClient = SolardemoSDK.TestSDK(null, setupOpts);
