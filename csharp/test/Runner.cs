// Solardemo SDK test runner - shared infrastructure for the generated
...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("SOLARDEMO_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("SOLARDEMO_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("SOLARDEMO_TEST_EXPLAIN");
    ...
    public static int LiveDelayMs()
    {
        ...
        {
            var n = SolardemoSdk.Helpers.ToInt(v);
            if (n >= 0)
            {
                return n;
            }
    ...
    public static Context MakeCtxFromMap(Dictionary<string, object?>? ctxmap,
        SolardemoSDK? client, Utility? utility)
    {
            ...
            resRaw is Dictionary<string, object?> resMap)
        {
            ...
            {
                ctx.Result.Err = new SolardemoError("", msg, null);
            }
        }
    ...
    public static void FixCtx(Context ctx, SolardemoSDK client)
    {
    ...
    public static Exception? ErrFromMap(Dictionary<string, object?>? m)
    {
        ...
        return new SolardemoError(code, msg, null);
    }
