...
public class SolardemoSDK
{
    ...
    public SolardemoSDK(Dictionary<string, object?>? options = null)
    {
        ...
        var config = global::SolardemoSdk.SdkConfig.SharedConfig();
        ...
        // the chain.
        var featureOpts = global::SolardemoSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(_options, "feature"))
        ...
        foreach (var fnameObj in featureOrder)
        {
            ...
            var fopts = global::SolardemoSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(featureOpts, fname));
            if (fopts != null &&
                fopts.TryGetValue("active", out var active) &&
                active is bool ab && ab)
            {
                _utility.FeatureAdd(_rootctx, global::SolardemoSdk.SdkConfig.MakeFeature(fname));
            }
        }
    ...
    {
        return global::SolardemoSdk.Utility.Copy(_utility);
    }
    ...
    public Dictionary<string, object?> Prepare(Dictionary<string, object?>? fetchargs)
    {
        ...
        var ctrl = global::SolardemoSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "ctrl"))
            ?? new Dictionary<string, object?>();
        ...
        var pathParams = global::SolardemoSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "params"))
            ?? new Dictionary<string, object?>();
        var query = global::SolardemoSdk.Helpers.ToMapAny(global::Voxgig.Struct.StructUtils.GetProp(fetchargs, "query"))
            ?? new Dictionary<string, object?>();
    ...
    private Dictionary<string, object?> OpDenied(string op)
    {
        ...
        {
            ["ok"] = false,
            ["err"] = new Exception("SolardemoSDK: " + op +
    ...
    private Dictionary<string, object?> RawRequest(Dictionary<string, object?>? fetchargs)
    {
        ...
        {
            var status = global::SolardemoSdk.Helpers.ToInt(global::Voxgig.Struct.StructUtils.GetProp(fm, "status"));
        ...
        Dictionary<string, object?>? ctrl = null)
    {
        ...
        if (null != errors && 0 < errors.Count)
        {
            ...
            res["ok"] = false;
            res["err"] = new Exception("SolardemoSDK: graphql: " + msg);
            res["graphql"] = errors;
        }
    ...
    // Idiomatic usage: client.Moon().List(null) or
    // client.Moon().Load(new() { ["id"] = ... }).
    public SolardemoEntityBase Moon(Dictionary<string, object?>? entopts = null)
    {
        return new global::SolardemoSdk.Entity.MoonEntity(this, entopts);
    }

    // Planet returns a Planet entity bound to this client.
    // Idiomatic usage: client.Planet().List(null) or
    // client.Planet().Load(new() { ["id"] = ... }).
    public SolardemoEntityBase Planet(Dictionary<string, object?>? entopts = null)
    {
        return new global::SolardemoSdk.Entity.PlanetEntity(this, entopts);
    }


    public static SolardemoSDK TestSDK(Dictionary<string, object?>? testopts,
        Dictionary<string, object?>? sdkopts)
    {
        ...
        var sdk = new SolardemoSDK(sdkopts)
        {
            Mode = "test",
        };
