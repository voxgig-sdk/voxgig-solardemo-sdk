...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "moon" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Moon client data) accessor delegates here.
...
;; Load a single Moon (reqmatch: id/query fields; nil = empty match).
...
;; List Moon items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Moon (reqdata: body data).
...
;; Update an existing Moon (reqdata: body data).
...
;; Remove an Moon matching the criteria (reqmatch: id/query fields).
