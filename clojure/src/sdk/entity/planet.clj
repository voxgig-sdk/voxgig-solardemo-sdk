...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "planet" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Planet client data) accessor delegates here.
...
;; Load a single Planet (reqmatch: id/query fields; nil = empty match).
...
;; List Planet items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Planet (reqdata: body data).
...
;; Update an existing Planet (reqdata: body data).
...
;; Remove an Planet matching the criteria (reqmatch: id/query fields).
