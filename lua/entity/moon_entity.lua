...
local MoonEntity = {}
MoonEntity.__index = MoonEntity


function MoonEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MoonEntity)
  self._name = "moon"
  self._client = client
...
function MoonEntity:get_name()
  return self._name
end


function MoonEntity:make()
  local opts = {}
...
function MoonEntity:mark_deleted()
  self._deleted = true
end


function MoonEntity:deleted()
  return true == self._deleted
end


function MoonEntity:data_set(args)
  if args ~= nil then
...
function MoonEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MoonEntity:match_set(args)
  if args ~= nil then
...
function MoonEntity:stream(action, args, callopts)
...
---@param reqmatch MoonLoadMatch
---@param ctrl? table
---@return Moon
---@return string? err
function MoonEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch MoonListMatch
---@param ctrl? table
---@return Moon[]
---@return string? err
function MoonEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata MoonCreateData
---@param ctrl? table
---@return Moon
---@return string? err
function MoonEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata MoonUpdateData
---@param ctrl? table
---@return Moon
---@return string? err
function MoonEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch MoonRemoveMatch
---@param ctrl? table
---@return Moon
---@return string? err
function MoonEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function MoonEntity:_run_op(ctx, post_done)
  local utility = self._utility
