...
---@param reqdata PlanetCreateData
---@param ctrl? table
---@return Planet
---@return string? err
function PlanetEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata PlanetUpdateData
---@param ctrl? table
---@return Planet
---@return string? err
function PlanetEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch PlanetRemoveMatch
---@param ctrl? table
---@return Planet
---@return string? err
function PlanetEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
