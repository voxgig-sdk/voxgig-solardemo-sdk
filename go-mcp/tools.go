...
type Args struct {
	Entity string         `json:"entity" jsonschema:"moon | planet"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SolardemoSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "solardemo_list",
		Description: "List records from Solardemo. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "solardemo_load",
		Description: "Load a single record from Solardemo. " +
...
func runOp(client *sdk.SolardemoSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SolardemoSDK, name string) (sdk.SolardemoEntity, error) {
	switch strings.ToLower(name) {
	case "moon":
		return client.Moon(nil), nil
	case "planet":
