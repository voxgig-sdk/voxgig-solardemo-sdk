...
from solardemo_sdk.feature.secrets.voxgig_sekreto import Sekreto, envkey
...
from solardemo_sdk.config import FEATURE_PLUGINS
...
class SolardemoSecretsFeature(SolardemoBaseFeature):
    def __init__(self):
        super().__init__()
        self.version = "0.1.0"
        self.name = "secrets"
    ...
    def init(self, ctx, fopts):
        ...
        # Seam for SolardemoSDK.prepare() (no feature hooks on that
