...
// tm/swift/Tests/SolardemoSDKTests/OmniResolver.swift, and it follows the
...
use solardemo_sdk::utility::voxgigstruct::ordered_map::OrderedMap;
use solardemo_sdk::utility::voxgigstruct::value::Value;
use solardemo_sdk::utility::voxgigstruct::InjectDef;
use solardemo_sdk::SolardemoError;
...
pub fn vget(val: &Value, key: &str) -> Value {
    solardemo_sdk::utility::voxgigstruct::lookup(val, &Value::str(key))
}
