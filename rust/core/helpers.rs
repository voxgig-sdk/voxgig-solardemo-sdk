// Shared Value helpers for the Solardemo SDK pipeline. The SDK data model
...
// underlying API spec doesn't define. The static SolardemoEntity trait
...
pub fn unsupported_op(opname: &str, entityname: &str) -> SolardemoError {
    SolardemoError::new(
        "unsupported_op",
        &format!(
