...
impl SolardemoSDK {
    ...
    pub fn moon(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::moon::MoonEntity> {
        crate::entity::moon::MoonEntity::new(self, entopts)
    }

    /// Planet entity bound to this client.
    pub fn planet(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::planet::PlanetEntity> {
        crate::entity::planet::PlanetEntity::new(self, entopts)
    }
