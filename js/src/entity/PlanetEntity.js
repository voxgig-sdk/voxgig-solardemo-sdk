...
class PlanetEntity extends SolardemoEntityBase {
  ...
  /**
   * @param {PlanetLoadMatch} [reqmatch]
   * @param {Object} [ctrl]
  ...
  /**
   * @param {PlanetListMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Planet[]>}
   */
  ...
  /**
   * @param {PlanetCreateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<Planet>}
   */
  ...
  /**
   * @param {PlanetUpdateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<Planet>}
   */
  ...
  /**
   * @param {PlanetRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Planet>}
   */
