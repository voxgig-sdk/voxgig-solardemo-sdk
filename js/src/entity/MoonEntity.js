...
class MoonEntity extends SolardemoEntityBase {
  ...
  /**
   * @param {MoonLoadMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Moon>}
   */
  ...
  /**
   * @param {MoonRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Moon>}
   */
