...
test('stream', (t) async {
    ...
    test('basic', (t) async {
      ...
      for (final op in ['create', 'list', 'update', 'load', 'remove']) {
        if (maybeSkipControl(t, 'entityOp', 'moon.' + op, live)) {
          return;
        }
      }
      ...
      // CREATE
      final moon_ref01_ent = client.Moon();
      dynamic moon_ref01_data = setup['data']['new']['moon']['moon_ref01'];
      moon_ref01_data['planet_id'] = setup['idmap']['planet01'];

      moon_ref01_data = (await moon_ref01_ent.create(moon_ref01_data)).data();
      ok(null != moon_ref01_data['id']);


      // LIST
      final moon_ref01_match = <String, dynamic>{};
      moon_ref01_match['planet_id'] = setup['idmap']['planet01'];

      final moon_ref01_list = (await moon_ref01_ent.list(moon_ref01_match)).map((e) => e.data()).toList();
      ...
      // UPDATE
      final moon_ref01_data_up0 = <String, dynamic>{};
      moon_ref01_data_up0['id'] = moon_ref01_data['id'];
      moon_ref01_data_up0['planet_id'] = setup['idmap']['planet_id'];

      final moon_ref01_markdef_up0 = <String, dynamic>{
        'name': 'kind',
        'value': 'Mark01-moon_ref01_' + setup['now'].toString(),
      };
      moon_ref01_data_up0[moon_ref01_markdef_up0['name']] = moon_ref01_markdef_up0['value'];

      final moon_ref01_resdata_up0 = (await moon_ref01_ent.update(moon_ref01_data_up0)).data();
      ok(moon_ref01_resdata_up0['id'] == moon_ref01_data_up0['id']);

      ok(moon_ref01_resdata_up0[moon_ref01_markdef_up0['name']] == moon_ref01_markdef_up0['value']);


      // LOAD
      final moon_ref01_match_dt0 = <String, dynamic>{};
      moon_ref01_match_dt0['id'] = moon_ref01_data['id'];
      final moon_ref01_data_dt0 = (await moon_ref01_ent.load(moon_ref01_match_dt0)).data();
      ok(moon_ref01_data_dt0['id'] == moon_ref01_data['id']);


      // REMOVE
      final moon_ref01_match_rm0 = <String, dynamic>{'id': moon_ref01_data['id']};
      await moon_ref01_ent.remove(moon_ref01_match_rm0);


      // LIST
      final moon_ref01_match_rt0 = <String, dynamic>{};
      moon_ref01_match_rt0['planet_id'] = setup['idmap']['planet01'];

      final moon_ref01_list_rt0 = (await moon_ref01_ent.list(moon_ref01_match_rt0)).map((e) => e.data()).toList();
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['moon01', 'moon02', 'moon03', 'planet01', 'planet02', 'planet03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['SOLARDEMO_TEST_MOON_ENTID'];
